...
function Polls_admin_new()
{
    ...
    $mainCat  = CategoryRegistryUtil::getRegisteredModuleCategory ('Polls', 'poll_desc', 'Main', 30); // 30 == /__SYSTEM__/Modules/Global
...
function Polls_admin_view()
{
    ...
    $pnRender->assign('polls', $rows);
    $pnRender->assign('polls_category', $category);
    $pnRender->assign('mainCategory', $mainCat);
    $pnRender->assign($modvars);

    // Assign the information required to create the pager
    $pnRender->assign('pager', array('numitems'     => pnModAPIFunc('Polls', 'user', 'countitems', array('category' => $category)),
